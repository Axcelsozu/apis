...
function getRandomPath() {
    ...
    brave: {
        ":method": "GET",
        ":authority": (Math.random() < 0.5 ? "" : "www.") + randstr(3) + parsedTarget.host,
        ":scheme": "https",
        ":path": getRandomPath() + "?" + generateRandomString(3) + "=" + generateRandomString(5, 10) + (Math.random() < 0.5 ? "#" + randstr(5) : ""),
        ...
        "sec-ch-ua-model": "",
        "sec-ch-ua-wow64": "?0",
        "sec-ch-ua-platform-version": Math.random() < 0.5 ? "15.0.0" : "10.0.0",
        "sec-ch-ua-full-version": Math.random() < 0.5 ? "124.0.6367.91" : "123.0.6312.86",
    ...
    safari: {
        ...
        "sec-ch-ua-wow64": "?0",
        "sec-ch-ua-platform-version": Math.random() < 0.5 ? "15.0.0" : "10.0.0",
        "sec-ch-ua-full-version": Math.random() < 0.5 ? "16.0.0" : "15.0.0",
        "accept": `text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8, application/json;q=0.5`,
